...
<div class="clearfix"></div>
        ...
        <form name="requestform" method="post" action="admin_request.php">
        ...
        <td width='200px;'><input class="btn btn-success" type="submit" name="approvebtn" value="Approve" onclick=""><input class="btn btn-danger" type="submit" name="rejectbtn" value="Reject" onclick="">
        </td>
        </form>
      </tr>
    <?php } }?>
    ...
    <?php
        ...
        if ($rec_count > 0)
          echo "<br /><br />Number of Request : ". $rec_count;
        else
...
if (isset($_POST['approvebtn'])) {
      ...
      $status = "Approved";
      $result = mysqli_query($conn,"UPDATE member SET Member_Status = '$status' WHERE Application_ID = '$AppID'");
      
      $id = mysqli_insert_id($conn);
      
      if ($result) {
         echo ("<SCRIPT LANGUAGE='JavaScript'>
             window.alert('A member has been approved.')
             window.location = 'admin_request.php?Application_ID=' + $id;
            </SCRIPT>");
      }else{
         echo ("<SCRIPT LANGUAGE='JavaScript'>
             window.alert('Fail')
            window.location = 'admin_request.php?result=fail';
            </SCRIPT>");
       }
    ...
    if (isset($_POST['rejectbtn'])) {
      ...
      if ($result) {
         echo ("<SCRIPT LANGUAGE='JavaScript'>
             window.alert('A member has been rejected.')
             window.location = 'admin_request.php?Application_ID=' + $id;
            </SCRIPT>");
      }else{
         echo ("<SCRIPT LANGUAGE='JavaScript'>
