        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="member" class="site_title"><i class="fa fa-paw"></i> <span>E-Sport Blue Club</span></a>
            </div>
                  ...
                  <div class="x_content">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="2"><center><a class="btn btn-success" href="member_profileedit.php">Edit</a></center></td>
                        </tr>
                      </tbody>
                    </table>
